...
public class SecurityUtils {
	...
	public List<Integer> getRoles() {
		...
		authorities.stream().filter(granted -> StrUtil.startWith(granted.getAuthority(), OauthConstants.ROLE))
				.forEach(granted -> {
					String id = StrUtil.removePrefix(granted.getAuthority(), OauthConstants.ROLE);
